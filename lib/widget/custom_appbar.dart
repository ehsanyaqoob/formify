...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  List<Widget> _buildOptionalIcons() {
    List<Widget> icons =
        isRTL ? _buildOptionalIconsArabic() : _buildOptionalIconsEnglish();
    // Wrap each icon in an InkWell to handle onTap
  ...
  Widget build(BuildContext context) {
    return Animate(
      ...
      child: AppBar(
        ...
        leadingWidth: isRTL ? (_buildOptionalIcons().length * 0.0) : null,
        titleSpacing: -10,
        title: Align(
        ...
        actions: [
          if (isRTL && showLeading) _buildBackButton(), // keep this
