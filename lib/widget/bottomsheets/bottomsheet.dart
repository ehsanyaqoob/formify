...
import 'package:formify/controller/auth-cont.dart';
import 'package:formify/widget/bottomsheets/bottomsheet_widgets.dart';
import 'package:formify/widget/custom_checkbox_widget.dart';
import 'package:formify/widget/custom_dropdown.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                MyButton(
                  ...
                  backgroundColor:
                      isOtpComplete ? kPrimaryColor : kPrimaryColor3,
                  onTap:
                      isOtpComplete
                          ? () {
            ...
            child: Column(
              ...
              children: [
                ...
                MyButton(
                  buttonText: "Verify OTP".tr,
                  backgroundColor:
                      isOtpCompletePhone ? kPrimaryColor : kPrimaryColor3,
                  onTap:
                      isOtpCompletePhone
                          ? () {
                            //Get.off(() => BottomNavBar());
                    ...
                    return Bounce(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              selectedOptionIndex == pollIndex
                                  ? kPrimaryColor3 // Change border color for selected option
                                  : kWhite,
                          border: Border.all(
                            width: 1.5,
                            color:
