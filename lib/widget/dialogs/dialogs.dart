...
import 'package:formify/widget/bottomsheets/bottomsheet.dart';
    ...
    Column(
      ...
      children: [
        Container(
          ...
          padding: const EdgeInsets.all(20),
          decoration: BoxDecoration(
            color: kDynamicBackground,
            borderRadius: BorderRadius.all(Radius.circular(30)),
          ),
          child: Column(
            children: [
              // Google icon instead of logout image
              Container(
                width: 92,
                height: 92,
                decoration: BoxDecoration(
              ...
              const Gap(10),
              MyText(
                text: "Continue with your Google account to access all features".tr,
                size: 14,
                color: kSubText,
                paddingBottom: 16,
                weight: FontWeight.w400,
